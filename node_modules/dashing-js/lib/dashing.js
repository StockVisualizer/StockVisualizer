...
module.exports.Dashing = function Dashing() {
  ...
  app.get('/events', dashing._protected, function(req, res) {
    ...
    // New
    // connections[conn.id] = {connection: conn, symbol: "AAPL" };
    // Original
  ...
  app.put('/search', function(req, res) {
    ...
    res.send(200);
    // process.env.ticker = req.body.ticker;
  });
  ...
  // Lod jobs files
  // don't just load the jobs, load them and pass this connection's symbol in the job
